...
const WEB_BASE = process.env.NEXT_PUBLIC_WEB_BASE_URL || 'https://cognode.app';
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-neutral-900/80 backdrop-blur-xl border border-white/10 rounded-[32px] p-8 shadow-2xl z-10 overflow-hidden">
        ...
        >
          By continuing, you agree to Cognode&apos;s <a href={`${WEB_BASE}/terms`} target="_blank" rel="noreferrer" className="text-neutral-400 hover:text-white transition-colors underline underline-offset-2">Terms</a> and <a href={`${WEB_BASE}/privacy`} target="_blank" rel="noreferrer" className="text-neutral-400 hover:text-white transition-colors underline underline-offset-2">Privacy Policy</a>
        </motion.p>
      </div>
