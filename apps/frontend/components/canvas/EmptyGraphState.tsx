...
export default function EmptyGraphState({ onExplore }: EmptyGraphStateProps) {
    return (
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
            {/* Logo Icon */}
            <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-green-500/20 to-green-600/10 flex items-center justify-center mb-6">
            ...
            <div className="absolute bottom-8 left-1/2 -translate-x-1/2">
                <div className="flex items-center gap-2 px-4 py-2 bg-neutral-900/50 border border-neutral-800 rounded-full">
                    <span className="text-neutral-500 text-sm">Search RabbitHole...</span>
