...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant, size, ...props }, ref) => {
        ...
        // Actually, `asChild` is very useful for Next.js Links. I'll remove Slot for now to keep it simple or install it.
        // I will install @radix-ui/react-slot later if needed. For now, just standard button logic but I'll remove Slot import.
