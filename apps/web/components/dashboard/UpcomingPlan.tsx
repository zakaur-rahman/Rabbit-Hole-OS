    ...
    return (
        <DashboardCard hover={false} className="bg-amber/5 border-amber/10 p-0 overflow-hidden">
            <div className="flex flex-col lg:flex-row">
                {/* Billing Summary */}
                <div className="flex-[1.5] p-8 border-b lg:border-b-0 lg:border-r border-ink/5 space-y-6">
                    <div className="flex items-center gap-3">
                        <div className="p-2 rounded-lg bg-amber/10 text-amber">
                            <Calendar className="w-5 h-5" />
                        </div>
                        <h3 className="text-xl font-serif font-black text-ink">Upcoming Cycle</h3>
                    </div>

                    <div className="grid grid-cols-2 gap-8">
                        <div className="space-y-1">
                            <span className="text-[10px] font-mono text-neutral-500 uppercase tracking-widest">Protocol Renewal</span>
                            <p className="text-lg font-mono text-ink">{renewalDate}</p>
                        </div>
                        <div className="space-y-1">
                ...
                {/* Payment & Actions */}
                <div className="flex-1 p-8 bg-ink/2 space-y-6">
                    ...
                    <div className="flex items-center gap-4 bg-ink/5 border border-ink/5 rounded-xl p-4">
                        <div className="bg-ink/5 p-2 rounded-lg text-neutral-400">
                    ...
                    <div className="flex flex-col gap-3">
                        <button className="text-[11px] font-mono text-amber hover:text-ink transition-colors flex items-center gap-2 group w-fit">
                            <span>Modify Payment Protocol</span>
                            <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                        </button>
                        <p className="text-[11px] font-mono text-neutral-600">
                            Have a cryptographic voucher? <button className="text-neutral-400 hover:text-ink underline underline-offset-4">Apply code</button>.
                        </p>
                    </div>
                </div>
            </div>
