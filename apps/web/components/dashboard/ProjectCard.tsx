...
export function ProjectCard({
    ...
    const statusColors = {
        synced: "text-emerald-400 bg-emerald-400/10 border-emerald-400/20",
        syncing: "text-amber-400 bg-amber-400/10 border-amber-400/20",
        error: "text-rose-400 bg-rose-400/10 border-rose-400/20",
        idle: "text-neutral-500 bg-white/5 border-white/10"
    };

    return (
        <DashboardCard delay={delay} className="p-0 overflow-hidden flex flex-col h-full group/project">
            {/* Header / Banner Area */}
            <div className="h-24 bg-neutral-900/50 relative overflow-hidden border-b border-white/5">
                <div className="absolute inset-0 bg-linear-to-br from-amber/5 to-transparent opacity-50" />
                <div className="absolute top-4 left-6 p-2 rounded-lg bg-neutral-900 border border-white/10 text-neutral-400 group-hover/project:text-amber transition-colors">
            ...
            <div className="p-7 flex-1 flex flex-col">
                <div className="space-y-1 mb-6">
                    <h3 className="text-xl font-serif font-black text-white group-hover/project:text-amber transition-colors">
                        {name}
                    </h3>
                    {description && (
                ...
                <div className="grid grid-cols-2 gap-4 mb-8">
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 text-neutral-400">
                            ...
                            <span className="text-[13px] font-mono font-bold text-neutral-200">{nodeCount}</span>
                        </div>
                    ...
                    <div className="space-y-1">
                        <div className="flex items-center gap-2 text-neutral-400">
                            ...
                            <span className="text-[13px] font-mono font-bold text-neutral-200">{lastSync}</span>
                        </div>
                ...
                <div className="mt-auto pt-6 border-t border-white/5 flex items-center justify-between">
                    <div className="flex items-center gap-1">
                        <button 
                            ...
                            className="p-2 text-neutral-500 hover:text-white hover:bg-white/5 rounded-lg transition-all group/sync disabled:opacity-50 disabled:cursor-not-allowed"
                            title="Sync Now"
                        >
                    ...
                    <button className="flex items-center gap-2 text-[11px] font-mono uppercase tracking-widest text-neutral-400 hover:text-white transition-colors">
